(function () {
  ...
  function buildCard(story) {
    ...
    return '<div class="story-list-card">'
      + '<a class="story-list-card-img" href="' + href + '" style="background-image: url(' + esc(story.image) + ')"></a>'
      + '<div class="story-list-right">'
      + '<div class="story-data-list"><p>' + bookSVG + esc(story.series || '—') + '</p></div>'
      + '<div class="story-title-list" data-aos="fade-up"><a href="' + href + '"><h1>' + esc(story.title) + '</h1></a></div>'
      + '<div class="story-preview" data-aos="zoom-in"><a href="' + href + '"><p>' + esc(story.preview) + '</p></a></div>'
